...
var $author$project$MainTest$suite = A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					'a lonely cell should die',
					function (_v0) {
						var lonelyCell = $elm$core$Set$singleton(
							_Utils_Tuple2(0, 0));
						var gridSize = _Utils_Tuple2(1, 1);
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Set$empty,
							A2($author$project$Main$evolveCells, gridSize, lonelyCell));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'cell with two neighbours should remain to next generation',
					function (_v1) {
						var gridSize = _Utils_Tuple2(1, 1);
						var expectedAliveCell = _Utils_Tuple2(0, 0);
						var cellsAlive = $elm$core$Set$fromList(
							_List_fromArray(
								[
									_Utils_Tuple2(-1, 0),
									_Utils_Tuple2(0, 0),
						...
						return A2(
							...
							A2(
								$elm$core$Set$member,
								expectedAliveCell,
								A2($author$project$Main$evolveCells, gridSize, cellsAlive)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'cell with three non-cosecutive neighbours should be alive next generation',
					function (_v2) {
						var gridSize = _Utils_Tuple2(1, 1);
						var expectedAliveCell = _Utils_Tuple2(0, 0);
						var cellsAlive = $elm$core$Set$fromList(
					...
					A2(
					$elm_explorations$test$Test$test,
					'cell should die from over population if more than 3 neighbours',
					function (_v3) {
						var gridSize = _Utils_Tuple2(1, 1);
						var expectedDeadCell = _Utils_Tuple2(0, 0);
						var cellsAlive = $elm$core$Set$fromList(
							_List_fromArray(
								[
									_Utils_Tuple2(-1, -1),
...
var pipeFilename = "/tmp/elm_test-9202.sock";
var net = require('net'),
